...
let mahsulot = prompt("Mahsulot turini kiriting (telefon, laptop, quloqchin):").toLowerCase();
let soni = Number(prompt("Nechta mahsulot olmoqchisiz?"));
let chegirma = prompt("Chegirma kartangiz bormi? (ha/yo'q)").toLowerCase();
...
if (chegirma === "ha" && jami > 300) {
    jami = jami * 0.9; // 10% chegirma
}

console.log("To‘lov summasi: $" + jami);
